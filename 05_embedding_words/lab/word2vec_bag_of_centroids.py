...
""" This file contains code to accompany the Kaggle tutorial "Deep learning goes to the movies".  
The code in this file is for Part 2 of the tutorial and covers Bag of Centroids for a Word2Vec model. 
This code assumes that you have already run Word2Vec and saved a model called "300features_40minwords_10context"
"""
...
if __name__ == '__main__':
    ...
    num_clusters = word_vectors.shape[0] // 5 # 1/5th of the vocabulary size or an average of 5 words per cluster
    ...
    elapsed = end - start
    print("Time taken for K Means clustering: ", int(elapsed), "seconds.")
